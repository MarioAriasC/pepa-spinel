...
module Evaluator
  ...
  def self.inner_eval(node, environment)
    ...
    when Past::HashLiteral
      eval_hash_literal(node, environment)
    when Past::ArrayLiteral
